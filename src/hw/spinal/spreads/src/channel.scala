...
case class Channel(S: Int, N: Int) extends Component {
  ...
  val lfsr1 = UnrollLFSR(poly1.toArray, poly1.max+1, 1, 14)
  lfsr1.io.skip := False
  ...
  val lfsr2 = UnrollLFSR(poly2.toArray, poly2.max+1, 2, 14)
  lfsr2.io.skip := False
  ...
  val lfsr3 = UnrollLFSR(poly3.toArray, poly3.max+1, 3, 14)
  lfsr3.io.skip := False
  ...
  val lfsr4 = UnrollLFSR(poly4.toArray, poly4.max+1, 1, 14)
  lfsr4.io.skip := False
